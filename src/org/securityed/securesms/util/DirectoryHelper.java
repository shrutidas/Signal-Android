...
import org.securityed.securesms.push.IasTrustStore;
import org.securityed.securesms.recipients.Recipient;
import org.securityed.securesms.recipients.RecipientId;
import org.securityed.securesms.sms.IncomingJoinedMessage;
...
public class DirectoryHelper {
  ...
  private static Optional<AccountHolder> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("org.securityed.securesms");
  ...
  private static Optional<AccountHolder> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "org.securityed.securesms");
