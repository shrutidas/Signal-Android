...
public class TextSecurePreferences {
  ...
  public static void addToUnsentLogs( @NonNull Context context, String log){
    ...
    setStringPreference(context, UNSENT_LOGS, rawLogs + "%%" + log);
  }

  public static String[] getUnsentLogs( @NonNull Context context){
  ...
  public static void deleteUnsentLogs( @NonNull Context context){

    setStringPreference(context, UNSENT_LOGS, "");
