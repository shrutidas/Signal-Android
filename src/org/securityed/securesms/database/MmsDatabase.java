 ...
 */
package org.securityed.securesms.database;
...
import org.securityed.securesms.attachments.MmsNotificationAttachment;
...
import org.securityed.securesms.database.documents.IdentityKeyMismatchList;
import org.securityed.securesms.database.documents.NetworkFailure;
import org.securityed.securesms.database.documents.NetworkFailureList;
...
import org.securityed.securesms.database.model.NotificationMmsMessageRecord;
...
import org.securityed.securesms.revealable.ViewOnceExpirationInfo;
...
import static org.securityed.securesms.contactshare.Contact.Avatar;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.securityed.securesms.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader implements Closeable {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.securityed.securesms.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.securityed.securesms.util.Util.toIsoBytes(transactionId);
