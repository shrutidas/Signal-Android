...
import org.securityed.securesms.sms.IncomingGroupMessage;
...
public class SmsDatabase extends MessagingDatabase {
  ...
  protected Optional<InsertResult> insertMessageInbox(IncomingTextMessage message, long type) {
    ...
    boolean    unread     = (org.securityed.securesms.util.Util.isDefaultSmsProvider(context) ||
                                  ...
                                  boolean forceSms, long date, InsertListener insertListener)
  {
    ...
    return insertMessageOutbox( threadId, message, forceSms, date, insertListener, true);
  }


  public long insertMessageOutbox(long threadId, OutgoingTextMessage message,
                                  boolean forceSms, long date, InsertListener insertListener, Boolean doLog)
  {
