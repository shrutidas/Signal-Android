package org.securityed.securesms.avatar;
...
import org.securityed.securesms.util.IntentUtils;
...
public final class AvatarSelection {
  ...
  private static Intent createAvatarSelectionIntent(Context context, @Nullable File tempCaptureFile, boolean includeClear) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("org.org.securityed.securesms.action.CLEAR_PROFILE_PHOTO"));
    }
