...
import org.securityed.securesms.mms.PartUriParser;
import org.securityed.securesms.service.KeyCachingService;
import org.securityed.securesms.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.org.securityed.provider.securesms/part";
  ...
  static {
    ...
    uriMatcher.addURI("org.org.securityed.provider.securesms", "part/*/#", SINGLE_ROW);
  }
