...
package org.securityed.securesms.logsubmit;
...
import org.securityed.securesms.logsubmit.util.Scrubber;
import org.securityed.securesms.util.BucketInfo;
...
public class SubmitLogFragment extends Fragment {
  ...
  private static CharSequence buildPermissions(@NonNull Context context) {
    ...
    try {
      PackageInfo info = context.getPackageManager().getPackageInfo("org.org.securityed.securesms", PackageManager.GET_PERMISSIONS);
